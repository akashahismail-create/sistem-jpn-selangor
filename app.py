...
with col_main:
    if st.session_state["menu"] == "Dashboard":
        ...
        # ===== V25 - DASHBOARD POWER NO 1 + NO 2 - BY AIRA =====
        # WARNING CARD AUTO
        ...
        if total_calon_check == 0 or total_pusat_check == 0:
            st.error("⚠️ Data masih kosong! Sila selenggara di menu Selenggara Data")
        else:
            # Ratio petugas vs calon
        ...
        # PLOTLY CHARTS - INTERAKTIF
        import plotly.express as px
        import plotly.graph_objects as go

        if jenis_data == "Calon" or jenis_data == "Semua":
            st.subheader("📊 Bilangan Calon Mengikut Daerah - Interaktif")
            ...
            # Plotly bar - hover cantik, tak bertindih
            ...
            fig1 = px.bar(df_calon_plot, x='Daerah', y='Bilangan', color='Jenis Calon', 
                          ...
                          hover_data={'Bilangan': True, 'Daerah': True})
            ...
            # PIE CHART - Pecahan Jenis Calon (No 1)
        ...
        if jenis_data == "Petugas" or jenis_data == "Semua":
            st.write("---")
            st.subheader("👮 Bilangan Petugas Mengikut Daerah - Interaktif")
